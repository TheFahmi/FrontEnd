    ...
    return (
      <div>
        ...
        <div className="row pt-3 w-100">
                    <div className="col-md-4 pl-5 pr-10">
                        <div className="p pb-3 font-weight-bolder" style={{ color: "#41aaa8", fontSize: 20 }}>
                    ...
                    <div className="col-md-5 pt-5">
                        ...
                        <div className="mt-3 ">
                            <button className="mr-3 btn btn-primary"onClick={this.onBeliTicketClick}><i className="fas fa-shopping-cart"></i> Beli Tiket</button>
                            <button className="mr-3 btn btn-outline-info " onClick={() => this.setState({ traileropen: true })}><i className="fas fa-video"></i> Trailer</button>
                        </div>
                    </div>
                </div>
            </div>
